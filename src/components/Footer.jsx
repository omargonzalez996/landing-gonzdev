...
const Footer = ({ footerData }) => {
    return (
        <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-10">
            <aside className='flex flex-col text-center md:text-left w-full md:flex-row justify-center md:justify-start items-center'>
                <CircularText
                    text={footerData.company}
                    onHover="speedUp"
                    spinDuration={20}
            ...
            <nav>
                ...
                <div>
                    <h6 className="footer-title mt-4">Contact</h6>
                    <a href={footerData.contact.email_href} className="text-sm cursor-pointer flex justify-start items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24"><path fill="currentColor" d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m0 4l-8 5l-8-5V6l8 5l8-5z"></path></svg>
                        <p>{footerData.contact.email}</p>
                    </a>
                    <a href={footerData.contact.phone_href} className="text-sm cursor-pointer flex justify-start items-center gap-2">
